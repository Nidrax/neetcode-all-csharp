...
public class TwoSumIITestCase : ITestCase
{
    public bool Run()
    {
    ...
    public int[] Numbers { get; init; } = null!;
    public int Target { get; init; }
    public int[] Expected { get; init; } = null!;
}

public class TwoSumIITest : Test
{
    public TwoSumIITest(ISolution solution)
    {
        TestCases = new List<ITestCase>
        {
            new TwoSumIITestCase
            {
                Solution = solution,
                Numbers = new[] {2, 7, 11, 15},
                Target = 9,
                Expected = new[] {1, 2}
            },
            new TwoSumIITestCase
    ...
    public TwoSumIITest() : this(new Solution()) { }
}
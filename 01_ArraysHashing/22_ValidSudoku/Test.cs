...
public class ValidSudokuTestCase : ITestCase
{ 
    public bool Run()
    {
...
public class ValidSudokuTest : Test
{
    public ValidSudokuTest(ISolution solution)
    {
        TestCases = new List<ITestCase>
        {
            new ValidSudokuTestCase
            {
                Solution = solution,
                Board = new[]
                {
    ...
    public ValidSudokuTest() : this(new Solution()) { }
}